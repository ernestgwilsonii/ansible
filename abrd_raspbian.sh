...
echo " ansible-playbook /etc/ansible/RaspberryPi_Raspbian-Apply-OS-Updates-playbook.yml --extra-vars 'HostOrGroup=raspberrypi'"
echo " ansible-playbook /etc/ansible/RaspberryPi_Raspbian-Install-Docker-playbook.yml --extra-vars 'HostOrGroup=raspberrypi'"
echo ""
echo "################################################################################"
echo ""
